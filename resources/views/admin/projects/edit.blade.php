                ...
                <div class="card mb-8">
                    ...
                    <div class="card-body">
                        <div class="col-lg-12">
                            ...
                            <form method="POST" id="productForm" action="{{ route('admin.projects.update', $project->id) }}">
                            @csrf
                                <div col-md-12>
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name_of_client" class="form-control" placeholder="{{ __('Name of Client') }}" value="{{ isset($project) ? $project->name_of_client : ''  }}" >
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label>Address</label>
                                                <textarea id="address" name="address" placeholder="Address" class="form-control">{{$project->address}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                            ...
                                            <label>Category:</label>
                                                <select type="text" name="category" id="categoryName" class="form-control">
                                                    ...
                                                    @foreach($categories as $key => $category)
                                                        <option value="{{ $key }}" {{$key == $project->category  ? 'selected' : ''}}>{{ $category }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select type="text" name="subcategory" id="subCategory" class="form-control">
                                                    ...
                                                    @foreach($subCategories as $key => $subCategory)
                                                        <option value="{{ $key }}" {{$key == $project->subcategory  ? 'selected' : ''}}>{{ $subCategory }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <label>Project Head:</label>
                                                <select type="text" name="project_head" class="form-control">
                                                    ...
                                                    @foreach($users as $key => $user)
                                                        <option value="{{ $key }}" {{$key == $project->project_head  ? 'selected' : ''}}>{{ $user }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        <vbnhdiv class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <select type="text" name="maintenance_engg" class="form-control">
                                                    ...
                                                    @foreach($users as $key => $user)
                                                        <option value="{{ $key }}" {{$key == $project->maintenance_engg  ? 'selected' : ''}}>{{ $user }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
