            ...
            <div class="col-lg-12">
                ...
                <div class="card mb-8">
                    ...
                    <div class="card-body">
                        ...
                        <form class="user" action="{{ route('admin.project_details.update', $project_details->id) }}" method="post">
                            @csrf
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6 mb-3 mb-sm-0">
                                    ...
                                    <div class="custom-control custom-checkbox">
                                          <input class="custom-control-input" name="categories_id[]" value="{{ $key }}" @if(isset($categoryId) && in_array($key,$categoryId)) checked @endif type="checkbox" id="customCheckbox{{ $key }}">
                                    ...
                                    @if($categorieName)
                                        ...
                                        @foreach($sub_categories as $subkey => $subcategory)
                                            @if($key === $subcategory->category_id)
                                              <li>
                                                <div class="custom-control custom-checkbox checkboxChild">
                                                    <input class="custom-control-input" name="subcategories_id[]" value="{{ $subcategory->id }}" @if(isset($subcategoriesId) && in_array($subcategory->id,$subcategoriesId)) checked @endif type="checkbox" id="subCheckbox{{ $subkey }}">
...
<script>
  $(document).ready(function (){
    ...
    $('ul > li.checkboxChild').each(function () {
