...
@section('content')
    <div class="">
        ...
        <div class="container row">
            <div class="col-lg-12">
                <h1 class="h3 mb-2 text-gray-800">{{ __('Add Roles in Permission') }}</h1>
                ...
                <div class="card mb-8">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <div class="card">
                            <form action="{{ route('admin.roles.permission.store') }}" method="POST">
                                @csrf
                                <div class="card-body col-lg-8">
                                    ...
                                    <div class="row">
                                        <div class="col-3">
                                            <div class="form-check">
                                                <input type="checkbox" name="group_id" class="form-check-input" id="checkGroup{{$key}}">
                                        ...
                                        @foreach($permissions as $permission)
                                            <div class="form-check mb-2">
                                                <input type="checkbox" name="permission[{{ $permission->id }}]" class="form-check-input" id="checkDefault{{ $permission->id }}" value="{{ $permission->id }}">
