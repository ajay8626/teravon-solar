        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    @endif
                    <div class="card">
                        <form action="{{ route('admin.general-check-points.store') }}" method="POST">
                            @csrf
                                    ...
                                    <div class="col-lg-6">
                                      ...
                                      <div class="col-sm-6">
                                         <div class="form-group">
                                            ...
                                            <input type="text" name="check_points_question" class="form-control" placeholder="Check Points Question">
                                         </div>
